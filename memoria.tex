...
Es a partir de este archivo SJR de donde partimos.
...
Gracias a este proyecto he aprendido a elaborar una aplicación web completa, a manejar el código, las funciones, la base de datos, los archivos…para que todo tenga una estructura ordenada y enlazada. Por supuesto afianzando y ampliando todo lo aprendido en las asignaturas del Grado mencionadas en sección anterior~\ref{sec:aplicacion_aprendido}. 
